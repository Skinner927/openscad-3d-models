//https://github.com/openscad/MCAD/blob/bd0a7ba3f042bfbced5ca1894b236cea08904e26/bearing.scad
// Fixed the coloring of the bearing's side shields
...
module bearing(pos=[0,0,0], angle=[0,0,0], model=SkateBearing, outline=false,
                material=Steel, sideMaterial=BlackPaint, center=false) {
  // Common bearing names
  model =
    model == "Skate" ? 608 :
    model;
